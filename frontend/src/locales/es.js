...
export default {
  ...
  'Attendance': 'Asistencia', 'Unique members who trained each day · last 4 weeks': 'Miembros distintos que entrenaron cada día · últimas 4 semanas',
  ...
  'Sin Domingo': 'Sin Domingo',
  'Con Domingo': 'Con Domingo',
  'Workouts': 'Entrenos',
  'This month': 'Este mes',
  ...
  'SIGN_IN_FAILED_LOGIN': 'Inicio de sesión fallido',
  ...
  'to install lauyim as a full-screen app.': 'para instalar lauyim como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if lauyim is closed.': 'Avisos del temporizador de descanso, incluso con lauyim cerrado.',
  ...
  'Admin': 'Administración', 'Back': 'Atrás', 'Refresh': 'Actualizar',
  'Loading…': 'Cargando…', 'never': 'nunca', 'just now': 'ahora mismo',
  '{0}m ago': 'hace {0} min', '{0}h ago': 'hace {0} h', '{0}d ago': 'hace {0} d',
  'active this week': 'activos esta semana', 'Users': 'Usuarios',
  ...
  'Anyone who opens this link can register without an invite code. The QR itself does not expire; regenerating it invalidates the previous one.': 'Quien abra este enlace puede registrarse sin código de invitación. El QR no caduca; regenerarlo invalida el anterior.',
  'This immediately invalidates the QR currently printed or shared. A new QR link will be generated.': 'Esto invalida inmediatamente el QR impreso o compartido. Se generará un nuevo enlace QR.',
  'QR access code': 'Código de acceso QR',
  'Code {0} created & copied': 'Código {0} creado y copiado', 'Code revoked': 'Código revocado', 'Copied {0}': '{0} copiado',
  'No codes yet — generate one to invite someone.': 'Aún no hay códigos: genera uno para invitar a alguien.',
  'Give the routine a name': 'Ponle un nombre a la rutina', 'Preset updated': 'Preset actualizado', 'Preset created': 'Preset creado',
  'Edit preset': 'Editar preset', 'New preset': 'Nuevo preset', 'Routine name': 'Nombre de la rutina',
  'Preset routines': 'Rutinas preestablecidas', 'Templates available from the starter plan action.': 'Plantillas disponibles al cargar el plan inicial.',
  'exercises': 'ejercicios', 'Preset deleted': 'Preset eliminado', 'No presets yet.': 'Aún no hay presets.', 'Save preset': 'Guardar preset',
  'Delete {0}?': '¿Eliminar {0}?', 'This removes it from the preset catalog. Existing user routines are unchanged.': 'Esto elimina la plantilla del catálogo. Las rutinas existentes no cambian.',
  'Clear the activity log?': '¿Vaciar el registro de actividad?', 'Every recorded event is deleted. The clear itself is logged, so the gap stays visible.': 'Se eliminarán todos los eventos. El vaciado también se registra para que el hueco sea visible.',
  'Clear': 'Vaciar', 'Activity log cleared': 'Registro de actividad vaciado', 'Activity log': 'Registro de actividad',
  'last {0} days': 'últimos {0} días', 'no IP addresses': 'sin direcciones IP', 'Sign-ins': 'Inicios de sesión', 'Failed': 'Fallidos',
  'Updated nutrition goals': 'Actualizó las metas nutricionales', 'Changed suggested meals limit': 'Cambió el límite de sugerencias',
  ...
  'A small file a friend imports into their own lauyim — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio lauyim: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Weekly undulating cycle: Heavy (1-5 reps) → Moderate (6-10 reps) → Light (12-15 reps). Progresses each day type independently.': 'Ciclo semanal ondulante: Pesado (1-5 reps) → Moderado (6-10 reps) → Ligero (12-15 reps). Progresa de forma independiente cada día.',
  ...
  'They will keep access to normal administrative tools only if promoted again.': 'Dejará de tener acceso a las herramientas de administración hasta que vuelva a ser promovido.',
  'Last sync': 'Última sincronización',
  'No users yet.': 'Aún no hay usuarios.',
  'Signed in': 'Sesión iniciada',
  'SIGN_IN_FAILED_SETTINGS': 'Error al iniciar sesión',
  'Created a profile': 'Perfil creado',
  'Profile creation failed': 'Error al crear el perfil',
  'Signup refused': 'Registro rechazado',
  'Signed out': 'Sesión cerrada',
  'Signed out everywhere': 'Sesión cerrada en todos los dispositivos',
  'Approved a device': 'Dispositivo aprobado',
  'Signed in from a paired device': 'Sesión iniciada desde un dispositivo vinculado',
  'Added a passkey': 'Llave de acceso añadida',
  'Disabled an account': 'Cuenta desactivada',
  'Re-enabled an account': 'Cuenta reactivada',
  'Created a preset': 'Rutina creada',
  'Updated a preset': 'Rutina actualizada',
  'Deleted a preset': 'Rutina eliminada',
  'Changed attendance settings': 'Configuración de asistencia modificada',
  'Created a membership plan': 'Creó un plan de cuota',
  'Updated a membership plan': 'Modificó un plan de cuota',
  'Assigned a membership plan': 'Asignó un plan de cuota',
  'Recorded a payment': 'Registró un pago',
  'Voided a payment': 'Anuló un pago',
  ...
  'Changed account approval': 'Cambió la aprobación de cuentas',
  'Approved a pending account': 'Habilitó una cuenta pendiente',
  'Rejected a pending account': 'Rechazó una cuenta pendiente',
  'Filled in their member details': 'Completó sus datos de socio',
  'Gave consent for health data': 'Dio su consentimiento de datos de salud',
  'Withdrew consent for health data': 'Retiró su consentimiento de datos de salud',
  'Deleted their health data': 'Borró sus datos de salud',
  ...
  'Revoked an invite code': 'Código de invitación revocado',
  'Sent a push notification': 'Notificación enviada',
  'Cleared the activity log': 'Registro de actividad borrado',
  'Blocked from the admin dashboard': 'Acceso bloqueado al panel de administración',
  'Blocked: owner access required': 'Acceso bloqueado: se requiere ser propietario',
  'Promoted to Admin': 'Ascendido a Admin',
  'Removed as Admin': 'Removido como Admin',
  'Deleted an account': 'Cuenta eliminada',
  'Unknown activity': 'Actividad no reconocida',
  'Usuarios: {0} ({1} Desactivados)': 'Usuarios: {0} ({1} Desactivados)',
  'Search users by name': 'Buscar usuarios por nombre',
  'No users match that name.': 'No hay usuarios que coincidan con ese nombre.',
  'First': 'Primera',
  'Previous': 'Anterior',
  'Last': 'Última',
  'Account permanently deleted': 'Cuenta eliminada permanentemente',
  'Delete {0} permanently?': '¿Eliminar permanentemente a {0}?',
  'This permanently deletes the disabled account and all of its stored training data. This cannot be undone.': 'Esto elimina permanentemente la cuenta desactivada y todos sus datos de entrenamiento almacenados. Esta acción no se puede deshacer.',
  ...
  'today': 'hoy',
  'the sign-in took too long and expired': 'el inicio de sesión tardó demasiado y caducó',
  'unknown passkey': 'llave de acceso desconocida',
  'the passkey could not be verified': 'no se pudo verificar la llave de acceso',
  'the passkey was rejected': 'la llave de acceso fue rechazada',
  'the passkey points at a profile that no longer exists': 'la llave de acceso apunta a un perfil que ya no existe',
  'the account is disabled': 'la cuenta está desactivada',
  'that passkey already belongs to a profile': 'esa llave de acceso ya pertenece a un perfil',
  'the invite code was used or revoked in the meantime': 'el código de invitación ya se usó o fue revocado',
  'wrong or already-used invite code': 'código de invitación incorrecto o ya utilizado',
  'wrong, used, expired or revoked link code': 'código de vinculación incorrecto, usado, vencido o revocado',
  'the member already has app access or is disabled': 'el socio ya tiene acceso a la app o está desactivado',
  'too many failed attempts, the link code was revoked': 'demasiados intentos fallidos: se revocó el código de vinculación',
  'primary': 'principal',
  ...
  'Synced with your lauyim server.': 'Sincronizado con tu servidor de lauyim.',
  ...
  'Sync this device to your own self-hosted lauyim instead.': 'Sincroniza este dispositivo con tu propio lauyim self-hosted.',
  'Pair the mobile app': 'Emparejar la app móvil',
  'Connect the lauyim app on your phone to this account.': 'Conecta la app de lauyim en tu móvil a esta cuenta.',
  'Could not generate a code': 'No se pudo generar un código',
  'On the lauyim app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'En la app de lauyim, elige «Conectar a mi servidor», luego introduce esta dirección y el código de abajo. Caduca en 5 minutos.',
  ...
  'Open Settings → “Pair the mobile app” on the lauyim site you’re already signed into, then enter its address and the code shown there.': 'En Ajustes → «Emparejar la app móvil» del sitio de lauyim en el que ya has iniciado sesión, luego introduce su dirección y el código que aparece ahí.',
  'Server address (e.g. gym.example.com)': 'Dirección del servidor (p. ej. gym.example.com)',
  'Pairing code': 'Código de emparejamiento',
  'Connecting…': 'Conectando…',
  'Connect': 'Conectar',
  'How do you want to use lauyim?': '¿Cómo quieres usar lauyim?',
  ...
  'Select exercise type': 'Selecciona el tipo de ejercicio',
  'Select primary muscle group': 'Selecciona el grupo muscular principal',
  'No se pudo compartir por QR': 'No se pudo compartir por QR',
  'Entrenamiento marcado como realizado': 'Entrenamiento marcado como realizado',
  'Ingresá asunto y mensaje': 'Ingresá asunto y mensaje',
  'Reporte enviado con éxito': 'Reporte enviado con éxito',
  'No se pudo enviar el reporte, intentá de nuevo': 'No se pudo enviar el reporte, intentá de nuevo',
  'Title and text are required': 'El título y el texto son obligatorios',
  'URL must start with http:// or https://': 'La URL debe comenzar con http:// o https://',
  'Invalid URL': 'URL no válida',
  'Notification sent to {0} subscriptions': 'Notificación enviada a {0} suscripciones',
  'Failed to send push': 'No se pudo enviar la notificación',
  'Failed to load attendance': 'No se pudo cargar la asistencia',
  'Failed to save setting': 'No se pudo guardar la configuración',
  'Límite de {0} grupos alcanzado.': 'Límite de {0} grupos alcanzado.',
  'Grupo "{0}" creado': 'Grupo "{0}" creado',
  'Grupo renombrado': 'Grupo renombrado',
  'Error al renombrar grupo': 'Error al renombrar grupo',
  'Grupo eliminado': 'Grupo eliminado',
  'Ingresa un código': 'Ingresa un código',

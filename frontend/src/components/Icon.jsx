// lauyim icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  vibrate: <><rect x="8" y="6.2" width="8" height="11.6" rx="2" /><path d="M5.2 9v6M2.8 10.4v3.2M18.8 9v6M21.2 10.4v3.2" /></>,
  ...
  apple: <><path d="M12 8.2c-1.5-2.1-4.5-1.8-5.9-.1-2.1 2.5-1.2 7.8 1.1 10.6 1.2 1.5 2.5 1.9 3.7.9.7-.6 1.5-.6 2.2 0 1.2 1 2.5.6 3.7-.9 2.3-2.8 3.2-8.1 1.1-10.6-1.4-1.7-4.4-2-5.9.1Z" /><path d="M12 8.2c.1-2.2 1.2-3.8 3.2-4.8M14.6 4.3c1.5-.2 2.7.2 3.5 1.1" /></>,
  ...
  mail: <><rect x="3.4" y="5.4" width="17.2" height="13.2" rx="2.4" /><path d="m3.8 7.8 8.2 6.2 8.2-6.2" /></>,
  ...
  copy: <><rect x="8.4" y="8.4" width="12.2" height="12.2" rx="2.6" /><path d="M15.6 8.4V6a2.6 2.6 0 0 0-2.6-2.6H6A2.6 2.6 0 0 0 3.4 6v7a2.6 2.6 0 0 0 2.6 2.6h2.4" /></>,
  grip: <path d="M9 6h.01M15 6h.01M9 12h.01M15 12h.01M9 18h.01M15 18h.01" style={{ strokeWidth: 3.2 }} />,

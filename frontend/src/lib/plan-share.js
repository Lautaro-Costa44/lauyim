...
//
// Two jobs:
//  1. A small, self-contained file a friend can import into THEIR lauyim — just the
...
export function parsePlan(raw) {
  ...
  if (!data || !data.lauyim_plan || !Array.isArray(data.routines)) {
    throw new Error(t('this isn’t an lauyim plan file'))
  }
